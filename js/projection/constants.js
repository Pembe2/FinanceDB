// js/projection/constants.js

export const RMD_LIFE_EXPECTANCY = {
...
export const scenarioNames = ["Minimum", "Medium", "Maximum"];
export const withdrawalNames = [
...
export const SETTINGS_KEY = "retirement_dashboard_settings_v9";
export const ACCOUNTS_KEY = "retirement_dashboard_accounts_v1";
export const SPENDING_KEY = "retirement_spending_estimator_v1";

export const drawdownTitles = [
